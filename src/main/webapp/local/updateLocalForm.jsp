	         ...
	         <div class="col-lg-4 mb-4 order-0">
	             <div class="card">
	              <div class="card-header-tabs">
			       <h3 class="card-title center">지역수정</h3>
			      </div>
	                 ...
	                 <div class="col-sm-12">
	                   <div class="card-body">
						...
						<div>
							...
							<form action="<%=request.getContextPath()%>/local/updateLocalAction.jsp?dbLocalName=<%=dbLocalName%>" method="post">
								<table>
									<tr>
										<td>변경할<br>지역이름</td>
										<td>
									...
									<button type="submit">지역변경</button>
							</form>
						</div>
	               	 </div>
	             </div>
